...
template <class VertexType>
void GraphType<VertexType>::GetToVerteices(VertexType vertex,QueType<VertexType>& adjVertices)
{
...
template <class VertexType>
void GraphType<VertexType>::BreadFirstSearch(VertexType startVertex,VertexType endVertex)
{

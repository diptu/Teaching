...
void StudentInfo::GetNextItem(long& item1, char& item2, float& item3)
{
    currentPos++;
...
void StudentInfo::InsertItem(long item1, char item2, float item3)
{
...
char StudentInfo::GetName(long item1)
{
    int location=0;
    while(item1!=ids[location])
        location++;

...
template<class T>
bool SinglyLinkedList<T>::isEmpty()(return head==NULL;)

template<class T>
int SinglyLinkedList<T>::listSize()(return length;)

template<class T>
boolSinglyLinkedList<T>::hasNext(return curptr!=NULL;)
...
template<class T>
void SinglyLinkedList<T>::reset(){curptr=head;}
